...
_HOT_WATER = snap_clamp(5.0, 10.0, 80.0)
...
class CircuitA(DiematicComponent):
    ...
    pump_on = bit(427, 4)
    slope = float10(20, writable=True, force_fc16=True, unit="K/K")
...
class CircuitB(DiematicComponent):
    ...
    pump_on = bit(428, 4)
    slope = float10(29, writable=True, force_fc16=True, unit="K/K")
...
class Settings(DiematicComponent):
    """Writable boiler-level configuration."""

    summer_winter_temp = float10(8, writable=True, force_fc16=True, unit="°C")
